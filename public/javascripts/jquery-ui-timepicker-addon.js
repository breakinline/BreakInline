...
$.extend(Timepicker.prototype, {
	...
	_injectTimePicker: function() {
		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			...
			// Breakinline Custom
			var displayHour = parseInt(hourMax) + 1;
			if (displayHour > 12) {
				displayHour = (displayHour - 12) + ' pm';
			} else {
				displayHour = displayHour + ' am';
			}
			jQuery('<span class=\"openHour\">Open Today until ' + displayHour + '</span>').insertBefore($buttonPanel);
			
			// End Breakinline Custom
